...
2. You can automatically sync or refresh the frontmatter by running:
   ...
   ```bash
   uv run --project . .agents/hooks/file-selector/sync_readme_tree.py <path/to/folder>
   ```

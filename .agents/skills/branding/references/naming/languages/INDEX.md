...
See [CONTRIBUTING.md](https://github.com/cofoundy/brand-skills/blob/main/CONTRIBUTING.md#adding-a-language-file) for the required sections and template. Use `pl.md` as the structural reference.

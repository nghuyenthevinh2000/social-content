...
See [CONTRIBUTING.md](https://github.com/cofoundy/brand-skills/blob/main/CONTRIBUTING.md#adding-an-industry-file) for required sections, file naming conventions, and the contribution workflow.

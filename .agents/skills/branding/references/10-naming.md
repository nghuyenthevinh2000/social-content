...
**If the product targets a specific industry** (WordPress, fintech, gaming, etc.), check [industries/INDEX.md](naming/industries/INDEX.md) for an industry-specific guide. Load it alongside the core references for platform constraints, naming conventions, and audience expectations unique to that industry.

**If the product is an open source project**, load [open-source.md](naming/open-source.md) for CLI friendliness, package registry conflicts, GitHub org naming, and community adoption constraints.

### Step 2: Metaphor Exploration

Don't brainstorm names yet. Brainstorm **metaphors and conceptual territories**.

Load [metaphor-mapping.md](naming/metaphor-mapping.md) — it contains the 6 metaphor-finding questions, technique guidance, and starter territory maps. Work through all 6 questions against your simplified core function.
Load [case-studies.md](naming/case-studies.md) for real examples of how products found their naming metaphors.
...
- [principles.md](naming/principles.md) — **foundational gates** — metaphor, story, phone test. Every candidate must pass these. Load first.
- [phonosemantics.md](naming/phonosemantics.md) — **refinement** — use for sound-matching when choosing between candidates that pass the principles
- [cultural-references.md](naming/cultural-references.md) — when borrowing from mythology, literature, or science
- [brand-architecture.md](naming/brand-architecture.md) — if naming within a brand family
- [language-rules.md](naming/language-rules.md) — when using foreign words or non-English source languages. Covers pronunciation accessibility, cross-language meaning checks, diacritics, transliteration, and the exoticism trap
- [case-studies.md](naming/case-studies.md) — real product naming examples by technique
- [languages/INDEX.md](naming/languages/INDEX.md) — if the naming brief targets a non-English language or multilingual audience. Check the index for available locale files, load the relevant one(s), and use its phonosemantic rules, word formation patterns, and cultural conventions instead of the English defaults
...
- [anti-patterns.md](naming/anti-patterns.md) — patterns that kill names
- [evaluation.md](naming/evaluation.md) — scoring rubric and comparison framework
...
Load [availability.md](naming/availability.md) for the full checking workflow and decision framework.
...
Load [evaluation.md](naming/evaluation.md) for the full framework.
...
- Tagline suggestions (see [taglines.md](naming/taglines.md) for guidance)
...
| File | When to load |
| ---- | ----------- |
| [principles.md](naming/principles.md) | **Foundational gates** — load first when generating or evaluating. Every candidate must pass these. |
| [phonosemantics.md](naming/phonosemantics.md) | **Refinement** — sound-matching for choosing between candidates that pass the principles |
| [anti-patterns.md](naming/anti-patterns.md) | When filtering candidates |
| [metaphor-mapping.md](naming/metaphor-mapping.md) | When exploring conceptual territories |
| [cultural-references.md](naming/cultural-references.md) | When considering mythology, literature, or science references |
| [brand-architecture.md](naming/brand-architecture.md) | When naming within a product family |
| [language-rules.md](naming/language-rules.md) | When using foreign words or non-English source languages |
| [availability.md](naming/availability.md) | When checking platform availability |
| [case-studies.md](naming/case-studies.md) | When studying real-world naming examples |
| [evaluation.md](naming/evaluation.md) | When scoring and comparing finalists |
| [languages/INDEX.md](naming/languages/INDEX.md) | When naming for a non-English audience — see index for available languages |
| [industries/INDEX.md](naming/industries/INDEX.md) | When naming for a specific industry — see index for available guides |
| [open-source.md](naming/open-source.md) | When naming an open source project — CLI, registry, and community constraints |
| [taglines.md](naming/taglines.md) | When crafting taglines for finalists |

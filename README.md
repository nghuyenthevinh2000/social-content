...
| [`jescil-richard-storytelling`](./.agents/skills/jescil-richard-storytelling/SKILL.md) | Use when writing social media posts, captions, LinkedIn content, or any short-form story that needs to hook, connect emotionally, and drive action. Use before drafting any narrative content. |
| [`story-integrity-interrogation`](./.agents/skills/story-integrity-interrogation/SKILL.md) | Run before writing any story, post, or narrative. This skill interrogates whether a story deserves to be told, whether the protagonist earns their transformation, and whether the storyteller's intent is honest. Pair with `jescil-richard-storytelling`, which handles craft and execution. |
